...
def user_pair_html(user_id, users_file='all_users.csv'):
    ...
    html_content = (
        ...
        f"<b>Образовательная программа:</b> {user_data['specialization'] if pd.notnull(user_data['specialization']) else 'Не указано'}\n"
...
def user_profile(chat_id, file_path='all_users.csv'):
    try:
